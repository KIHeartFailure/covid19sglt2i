...
tab1func <- function(data, datamatch, stratavar, title) {
  ...
  footnote(
    ...
    symbol = c(
      ...
      "Included in  the cox regression/propensity score models for outcome death as a continuous month variable.",
...
tab1func(
  ...
  datamatch = match_sglt2i_cov, stratavar = "sos_ddr_sglt2i", title = "Covid-19 patients by sglt2i"
)
```
...
tab1func(
  data = pop %>% filter(sos_covidconfirmed == "Yes"),
  datamatch = match_glp1a_cov, stratavar = "sos_ddr_glp1a", title = "Covid-19 patients by glp1a"
)
```
...
tab1func(
  data = pop %>% filter(sos_covidconfirmed == "Yes"),
  datamatch = match_dpp4i_cov, stratavar = "sos_ddr_dpp4i", title = "Covid-19 patients by dpp4i"
)
```
