...
The time to all-casue mortality is presented in 1-KM curves for the matched population.
...
- Adjusted for the individual variables indicated in Table \ref{tab:tab1allsglt2match}. 
Age was modelled using a cubic spline with 4 df.
- Adjusted through propensity score matching, using the same variables as above. The matched pairs were incorporated in the 
